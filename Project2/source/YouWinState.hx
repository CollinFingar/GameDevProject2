...
class YouWinState extends FlxState
{
	...
	override public function create():Void
	{
		...
		title = new FlxText(0, FlxG.height / 3, FlxG.width, "You Win!" );
		loading = new FlxText( 0, FlxG.height / 2, FlxG.width, "Loading..." );
		
		opt0txt = new FlxText(0, FlxG.height / 2 + 0, FlxG.width, "Play from the Beginning");
		opt1txt = new FlxText(0, FlxG.height / 2 + 96, FlxG.width, "Take me to the Main Menu");
